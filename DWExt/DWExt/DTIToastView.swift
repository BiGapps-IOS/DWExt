...
class DTIToastView: UIView {
    ...
    override func layoutSubviews() {
        ...
        self.imageView.frame = CGRect(origin: CGPoint(x: self.bounds.centerXInRect(rect: rect).origin.x, y: self.verticalPadding), size: imageSize).integral
        ...
        self.label.frame = CGRect(origin: CGPoint(x: self.bounds.centerXInRect(rect: rect).origin.x, y: self.verticalPadding+imageAdjustment), size: textSize).integral
    }
